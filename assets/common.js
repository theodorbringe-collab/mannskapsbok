...
// Krev innlogging – ellers redirect til login
...
// Send e-post med 6-sifret kode (OTP)
export async function signInEmailOtp(email){
  ...
  const { error } = await sb.auth.signInWithOtp({
    ...
    options:{
      ...
      emailRedirectTo: redirect // valgfri magisk lenke i samme e-post
    }
  });
  if(error) throw error;
}

// Verifiser koden fra e-posten
